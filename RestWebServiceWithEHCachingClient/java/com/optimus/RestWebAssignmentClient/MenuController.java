	...
	protected void doGet(HttpServletRequest request,
		...
		if (type.equals("getEmployeeDetails")) {
			...
			try {
				...
				URL url = new URL(
						"http://localhost:8080/RestWsEHCaching/webapi/optimus/v1/employeeDetails");
				...
				/*
				 * If response code is not equal to 200 then it displays Failed
		...
		if (type.equals("getParticularEmployee")) {
			// Redirect to updateEmployee.jsp
			response.sendRedirect("getParticularEmployee.jsp");
		}
